...
/*
	...
	public function cargarGafetePDF($idEvento, $evento, $registro, $func, $ctrl = null)
	{
		...
		$pdf->writeHTMLCell('90', '', $x='2', $y='79', $nombre, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);

		$pdf->SetFont('helvetica', '', 16);
		//$pdf->writeHTMLCell('100', '', $x='-15', $y='90', $apellidos, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
		$pdf->writeHTMLCell('90', '', $x='2', $y='89', $apellidos, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
		...
		if (isset($registro->foto_fotografia))
		{
			...
			$pdf->Image('@' . base64_decode($registro->foto_fotografia), $x='52', $y='5', 30, 32); //  40, 42
		}
