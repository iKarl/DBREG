...
/*
	...
	public function cargarGafetePDF($idEvento, $evento, $registro, $func, $ctrl = null)
	{
		...
		if (isset($registro->foto_fotografia))
		{
			...
			$pdf->Image('@' . base64_decode($registro->foto_fotografia), $x='2', $y='3', 3, 3.2); //  40, 42
		}
		...
		$pdf->write1DBarcode($func->nombreImagenBarcode($registro->id_registro), 'C128A', $x='3', $y='4.5', '', 2, 0.1, $style, 'N');
