...
/*
	...
	public function cargarGafetePDF($idEvento, $evento, $registro, $func, $ctrl = null)
	{
		...
		if ($registro->cat_registro == "DELADM") {
			...
			$pdf->SetFont('helvetica', 'B', 20);
			$pdf->writeHTMLCell('90', '', $x='5', $y='98', $pais, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			$pdf->writeHTMLCell('90', '', $x='115', $y='98', $pais, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			...
			$pdf->SetFont('helvetica', 'B', 20);
			$pdf->writeHTMLCell('90', '', $x='5', $y='93', $nombreApp, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			$pdf->writeHTMLCell('90', '', $x='115', $y='93', $nombreApp, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			$pdf->SetFont('helvetica', 'B', 20);
			...
			$pdf->writeHTMLCell('90', '', $x='115', $y='83', $nombreApp, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			$pdf->SetFont('helvetica', 'B', 18);
			$pdf->writeHTMLCell('90', '', $x='5', $y='98', "Invitado", $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			$pdf->writeHTMLCell('90', '', $x='115', $y='98', "Invitado", $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			...
			$pdf->writeHTMLCell('90', '', $x='115', $y='83', $nombreApp, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			$pdf->SetFont('helvetica', 'B', 18);
			$pdf->writeHTMLCell('90', '', $x='5', $y='98', "CITEL", $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
			$pdf->writeHTMLCell('90', '', $x='115', $y='98', "CITEL", $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
		}
