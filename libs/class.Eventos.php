...
/*
	...
	public function cargarGafetePDF($idEvento, $evento, $registro, $func, $ctrl = null)
	{
		...
		$pdf->writeHTMLCell('130', '', $x='5', $y='90', $nombre, $border=1, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);

		$pdf->SetFont('helvetica', '', 16);
		//$pdf->writeHTMLCell('100', '', $x='-15', $y='90', $apellidos, $border=0, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
		$pdf->writeHTMLCell('130', '', $x='5', $y='100', $apellidos, $border=1, $ln=0, $fill=0, $reseth=true, $align='C', $autopadding=false);
		...
		if (isset($registro->foto_fotografia))
		{
			...
			$pdf->Image('@' . base64_decode($registro->foto_fotografia), $x='90', $y='15', 30, 32); //  40, 42
		}
